...
let bareMode = false;
let isTabletView = window.innerWidth <= 1024 && window.innerWidth > 600;
let isMobileView = window.innerWidth <= 600 && window.innerWidth > 320;
let isVerySmallView = window.innerWidth <= 320;
...
// Function to adjust UI for different screen sizes
function adjustForScreenSize() {
  ...
  if (bareMode) {
    ...
    if (isVerySmallView) {
      body.style.fontSize = "9px";
      USERINPUT.style.fontSize = "9px";
    } else if (isMobileView) {
      body.style.fontSize = "12px";
      USERINPUT.style.fontSize = "12px";
    } else if (isTabletView) {
      body.style.fontSize = "16px";
